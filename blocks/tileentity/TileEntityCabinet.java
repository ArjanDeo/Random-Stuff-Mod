package com.republicofgamers.randomstuffmod.blocks.tileentity;

import com.republicofgamers.randomstuffmod.blocks.container.ContainerCabinet;
...
public class TileEntityCabinet extends TileEntityLockableLoot implements ITickable
{
	...
	{
		return new ContainerCabinet(playerInventory, world, pos, this, playerIn);
	}
	
	@Override
	public String getGuiID() 
	{
		return Reference.MOD_ID + ":cabinet";
	}
	...
	public void update()
	{
		if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            for (EntityPlayer entityplayer : this.world.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB((double)((float)pos.getX() - 5.0F), (double)((float)pos.getY() - 5.0F), (double)((float)pos.getZ() - 5.0F), (double)((float)(pos.getX() + 1) + 5.0F), (double)((float)(pos.getY() + 1) + 5.0F), (double)((float)(pos.getZ() + 1) + 5.0F))))
            {
                ...
                {
                    if (((ContainerCabinet)entityplayer.openContainer).getChestInventory() == this)
                    {
