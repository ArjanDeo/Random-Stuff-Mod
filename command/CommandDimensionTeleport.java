package com.republicofgamers.randomstuffmod.command;

import java.util.List;

import com.google.common.collect.Lists;
import com.republicofgamers.randomstuffmod.command.util.Teleport;
...
public class CommandDimensionTeleport extends CommandBase
{
	...
	private final List<String> aliases = Lists.newArrayList(Reference.MOD_ID, "tp", "tpdim", "tpdimension", "teleportdim", "teleportdimension","teleport");
