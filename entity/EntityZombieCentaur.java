package com.republicofgamers.randomstuffmod.entity;

import com.republicofgamers.randomstuffmod.init.ModItems;
import com.republicofgamers.randomstuffmod.util.handlers.SoundsHandler;
...
public class EntityZombieCentaur extends EntityCow
{

	public EntityZombieCentaur(World worldIn) 
	{
		super(worldIn);
	...
	{
		return new EntityZombieCentaur(world);
	}
