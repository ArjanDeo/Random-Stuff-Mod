...
public class ChunkGeneratorDiamond implements IChunkGenerator
{
    ...
    protected static final IBlockState OTHER_BLOCK1 = ModBlocks.RUBY_BLOCK.getDefaultState();
    ...
    */
	...
	private Object hellSpringGen;

    public ChunkGeneratorDiamond(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.DIAMOND_BIOME);
        }
    ...
    public void populate(int x, int z)
    {
       ...
       // {
      //      for (int k = 0; k < 8; ++k) { ((WorldGenHellLava) this.hellSpringGen).generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16) + 8, this.rand.nextInt(120) + 4, this.rand.nextInt(16) + 8)); }
       // }
